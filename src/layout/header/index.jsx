        ...
        <div className="container max-w-screen-xl mx-auto flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            <div className="flex items-center gap-2 text-xs sm:text-sm">
              ...
              <a href="/cv-15.09.25.pdf" download className="sm:font-medium flex items-center gap-2 px-3 py-1.5 lg:py-2 rounded-full bg-black text-white transition hover:bg-black hover:bg-opacity-85">
